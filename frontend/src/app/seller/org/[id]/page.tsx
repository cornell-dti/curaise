  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-3xl space-y-4">
      <div className="space-y-2">
        ...
        <div className="bg-gray-100 text-gray-800 px-4 py-2 rounded-md font-medium text-sm sm:text-base mt-2 sm:mt-0">
          Welcome, admin!
        </div>
        ...
        <div className="space-y-2 sm:flex sm:space-y-0 items-center gap-4 mx-auto w-full">
          ...
          {org.instagramUsername && (
            <Button
              variant="outline"
              size="lg"
              className="h-10 items-center w-full"
            >
              <Link
                href={`https://www.instagram.com/${org.instagramUsername}`}
