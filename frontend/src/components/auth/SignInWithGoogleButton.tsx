...
const SignInWithGoogleButton = () => {
  return (
    <Button
      type="button"
      variant="secondary"
      className="font-[nunito] font-[300] text-base sm:text-lg w-64 sm:w-auto flex items-center justify-center gap-2 bg-[#33363F] text-white hover:bg-[#50535d] focus:ring-2 focus:ring-[#33363F] focus:ring-offset-2 focus:ring-offset-white rounded-lg shadow-sm transition duration-200 ease-in-out"
      onClick={() => {
        signInWithGoogle();
      }}
    >
      {/* Google Logo SVG */}
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48" className="flex-shrink-0">
