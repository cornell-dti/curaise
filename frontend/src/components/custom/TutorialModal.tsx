...
const slides: Slide[] = [
	...
	},
	{
		...
		points: [
			...
			"To speed up approval, make sure your organization page includes a website or Instagram link to prove it's a Cornell org.",
		],
	},
	{
		section: "Seller",
	...
	},
	{
		...
		points: [
			...
			"A confirmation email will be sent from postmaster@sandbox082eab5ac11d4c279f63018b4b3d8419.mailgun.org.",
...
export default function TutorialModal({
	...
	const visibleSlides = slides.filter(
		(s) => s.section === "Getting Started" || s.section.toLowerCase() === userRole,
	);
