        ...
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu className="gap-7">
              ...
              {/* TODO: @STEVEN FIX AND REPLACE WITH CHELSEA'S PAGE */}
              {/* <SidebarMenuItem key="overview">
                ...
                >
                  <a
                    href={`/seller/fundraiser/${fundraiser.id}`}
              ...
              <SidebarMenuItem key="analytics">
                ...
                >
                  <a
                    href={`/seller/fundraiser/${fundraiser.id}/analytics`}
                    className="text-lg md:text-xl"
                  >
              ...
              <SidebarMenuItem key="orders">
                ...
                >
                  <a
                    href={`/seller/fundraiser/${fundraiser.id}/orders`}
                    className="text-lg md:text-xl"
                  >
